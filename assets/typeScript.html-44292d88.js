import{_ as n,o as s,c as a,a as p}from"./app-2c7e8012.js";const e={},t=p(`<h1 id="关于" tabindex="-1"><a class="header-anchor" href="#关于" aria-hidden="true">#</a> 关于</h1><p>整理自TS官方文档、阮一峰博客、b站大佬：小满zs 的教学视频，仅用作个人学习。</p><h2 id="类型声明" tabindex="-1"><a class="header-anchor" href="#类型声明" aria-hidden="true">#</a> 类型声明</h2><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// 字符串</span>
