import{_ as n,o as s,c as a,a as t}from"./app-2c7e8012.js";const p={},e=t(`<h2 id="ioc控制反转" tabindex="-1"><a class="header-anchor" href="#ioc控制反转" aria-hidden="true">#</a> IOC控制反转</h2><p>主要是用于改变基类与依赖基类的子类的强耦合关系，在引入 IOC 容器 Container 之后，A B C 之间的代码逻辑已经解耦了，可以单独拓展其他功能，也可以方便地加入其他模块D，在复杂的后端业务逻辑中，引入IOC可以降低组件之间的耦合度，实现系统各层之间的解耦，减少维护和理解成本；</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">class</span> <span class="token class-name"><span class="token constant">A</span></span> <span class="token punctuation">{</span>
